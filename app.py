...
def updateDDBB():
    ...
    try:
        ...
        if msg == "alta":
            ...
            resp.message("""Por favor, envíe la palabra *ALTA* o *BAJA* para darte de ALTA/BAJA en el servicio de alarma del PVPC. Recibirá un mensaje cada día a las 20:30 GMT+01:00 con el PVPC del próximo día.""")
